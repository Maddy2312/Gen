          ...
          <div className="text-center py-24 bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5 rounded-3xl space-y-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-black/40 dark:text-white/40">
                Check back later for new inventory listings.
              </p>
            </div>
          </div>
        ) : (
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                      <div className="flex justify-between items-center">
                        <span className="text-[9px] font-black tracking-[0.2em] uppercase text-black/40 dark:text-white/40">
                          {product.brand}
                        </span>
                        {minPrice !== null && (
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-black/5 dark:border-white/5">
                    <div className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-wider text-black/40 dark:text-white/40">
                      <Layers size={14} /> {variants.length}{" "}
                      {variants.length === 1 ? "Variant" : "Variants"} available
                    </div>

                    <Link className="flex items-center gap-1 text-xs font-black uppercase tracking-wider bg-black dark:bg-white text-white dark:text-black px-4 py-2.5 rounded-xl hover:opacity-80 transition">
